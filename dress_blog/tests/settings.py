...
DATABASES = {
    'default': {
        ...
        'NAME':     'django_dress_media_test.db',
        'USER':     '', 
        'PASSWORD': '', 
        'HOST':     '', 
        'PORT':     '',
...
STATIC_ROOT = os.path.join(os.path.abspath(os.path.curdir), 'tests')
...
ROOT_URLCONF = 'dress_blog.tests.urls'
...
DRESS_BLOG_THEMES_PATH = os.path.join(STATIC_ROOT, "themes")
